...
<?php include "includes/admin_navigation.php"; ?>
    <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                            <i class="fa fa-dashboard"></i>  <a href="index.php"> Dashboard /</a> <a href="home2.php"> card 3</a>
                            </li>
                            <!-- <li class="active">
      ...
      <h1>fertilizers / Accessories Category</h1>
      <br>
      <br>
...
switch($source) {
    ...
    include "includes/home2_edit.php";
    break;
    
    case 'view_post';
    include "includes/view_home2.php";
    break;
