            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.php">Dashboard /</a> <a href="accessories.php">Accessories</a>
                            </li>
                            <!-- <li class="active">
...
switch($source) {
    ...
    case 'add_post';
     ...
     include "includes/accessories_add.php";
    ...
    include "includes/accessorie_edit.php";
    break;
    
    case 'view_post';
    include "includes/view_all_accessories.php";
    break;
