            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.php">Dashboard /</a> <a href="seeds.php">Seeds</a>
                            </li>
                            <!-- <li class="active">
...
switch($source) {
    ...
    case 'add_post';
     ...
     include "includes/seeds_add.php";
    ...
    include "includes/seed_edit.php";
    break;
    
    case 'view_post';
    include "includes/view_all_seeds.php";
    break;
